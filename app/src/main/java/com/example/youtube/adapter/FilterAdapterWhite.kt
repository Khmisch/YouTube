...
class FilterAdapterWhite (var context: Context, var items: ArrayList<Filter>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if(viewType == TYPE_ADDED_YES){
            val view = LayoutInflater.from(parent.context).inflate(R.layout.item_feed_filter_explore_white, parent, false)
            return FeedViewHolderExplore(view)
        }
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_feed_filter_white, parent, false)
